...
const articlesData = [
  {
    ...
    path: "/gyantocode/how-to-create-custom-aliases-in-vite-for-cleaner-imports-20pk",
    url: "https://dev.to/gyantocode/how-to-create-custom-aliases-in-vite-for-cleaner-imports-20pk",
    comments_count: 0,
    ...
    canonical_url:
      "https://dev.to/gyantocode/how-to-create-custom-aliases-in-vite-for-cleaner-imports-20pk",
    ...
    tag_list: ["react", "gyantocode", "programming", "vite"],
    tags: "react, gyantocode, programming, vite",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
  ...
  },
  {
    ...
    path: "/gyantocode/without-jwt-library-decode-and-verify-a-jwt-token-in-javascript-17mk",
    url: "https://dev.to/gyantocode/without-jwt-library-decode-and-verify-a-jwt-token-in-javascript-17mk",
    comments_count: 0,
    ...
    canonical_url:
      "https://dev.to/gyantocode/without-jwt-library-decode-and-verify-a-jwt-token-in-javascript-17mk",
  ...
  },
  {
    ...
    path: "/gyantocode/learning-nodejs-with-expressjs-a-day-by-day-guide-3ope",
    url: "https://dev.to/gyantocode/learning-nodejs-with-expressjs-a-day-by-day-guide-3ope",
    comments_count: 0,
    public_reactions_count: 0,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/learning-nodejs-with-expressjs-a-day-by-day-guide-3ope",
    ...
    tag_list: ["tutorial", "node", "express", "gyantocode"],
    tags: "tutorial, node, express, gyantocode",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
      twitter_username: null,
  ...
  },
  {
    ...
    path: "/gyantocode/how-to-search-amazon-products-using-nodejs-and-amazon-pa-api-2g65",
    url: "https://dev.to/gyantocode/how-to-search-amazon-products-using-nodejs-and-amazon-pa-api-2g65",
    comments_count: 0,
    public_reactions_count: 0,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/how-to-search-amazon-products-using-nodejs-and-amazon-pa-api-2g65",
  ...
  },
  {
    ...
    path: "/gyantocode/how-to-record-and-upload-your-voice-using-react-native-b6e",
    url: "https://dev.to/gyantocode/how-to-record-and-upload-your-voice-using-react-native-b6e",
    comments_count: 1,
    ...
    canonical_url:
      "https://dev.to/gyantocode/how-to-record-and-upload-your-voice-using-react-native-b6e",
    ...
    reading_time_minutes: 4,
    tag_list: ["reactnative", "voicerecorderapp", "speechtotext", "gyantocode"],
    tags: "reactnative, voicerecorderapp, speechtotext, gyantocode",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
      twitter_username: null,
  ...
  },
  {
    ...
    path: "/gyantocode/download-base64-audio-files-in-react-in-two-ways-28pl",
    url: "https://dev.to/gyantocode/download-base64-audio-files-in-react-in-two-ways-28pl",
    comments_count: 0,
    public_reactions_count: 0,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/download-base64-audio-files-in-react-in-two-ways-28pl",
  ...
  },
  {
    ...
    path: "/gyantocode/how-to-cancel-api-calls-in-react-with-axios-a-step-by-step-guide-41b6",
    url: "https://dev.to/gyantocode/how-to-cancel-api-calls-in-react-with-axios-a-step-by-step-guide-41b6",
    comments_count: 1,
    public_reactions_count: 0,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/how-to-cancel-api-calls-in-react-with-axios-a-step-by-step-guide-41b6",
  ...
  },
  {
    ...
    path: "/gyantocode/how-to-track-localstorage-update-in-different-tabs-and-same-tab-3f30",
    url: "https://dev.to/gyantocode/how-to-track-localstorage-update-in-different-tabs-and-same-tab-3f30",
    comments_count: 0,
    ...
    canonical_url:
      "https://dev.to/gyantocode/how-to-track-localstorage-update-in-different-tabs-and-same-tab-3f30",
    ...
    reading_time_minutes: 4,
    tag_list: ["gyantocode", "webdev", "programming", "react"],
    tags: "gyantocode, webdev, programming, react",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
      twitter_username: null,
  ...
  },
  {
    ...
    path: "/gyantocode/how-to-track-user-inactivity-on-your-website-and-why-it-matters-2b7h",
    url: "https://dev.to/gyantocode/how-to-track-user-inactivity-on-your-website-and-why-it-matters-2b7h",
    comments_count: 0,
    public_reactions_count: 0,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/how-to-track-user-inactivity-on-your-website-and-why-it-matters-2b7h",
    ...
    tag_list: ["gyantocode", "userinactive", "react", "webdev"],
    tags: "gyantocode, userinactive, react, webdev",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
      twitter_username: null,
  ...
  },
  {
    ...
    path: "/gyantocode/building-a-custom-audio-player-in-react-a-step-by-step-guide-25d0",
    url: "https://dev.to/gyantocode/building-a-custom-audio-player-in-react-a-step-by-step-guide-25d0",
    comments_count: 0,
    public_reactions_count: 5,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/building-a-custom-audio-player-in-react-a-step-by-step-guide-25d0",
    ...
    reading_time_minutes: 4,
    tag_list: ["gyantocode", "audioplayer", "customaudioplayer", "react"],
    tags: "gyantocode, audioplayer, customaudioplayer, react",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
      twitter_username: null,
  ...
  },
  {
    ...
    path: "/gyantocode/mastering-javascript-objects-comparison-manipulation-and-control-techniques-g53",
    url: "https://dev.to/gyantocode/mastering-javascript-objects-comparison-manipulation-and-control-techniques-g53",
    comments_count: 0,
    public_reactions_count: 1,
    collection_id: null,
    ...
    canonical_url:
      "https://dev.to/gyantocode/mastering-javascript-objects-comparison-manipulation-and-control-techniques-g53",
    ...
    tag_list: ["gyantocode", "javascript", "webdev", "development"],
    tags: "gyantocode, javascript, webdev, development",
    user: {
      name: "Nilesh Kumar",
      username: "gyantocode",
      twitter_username: null,
